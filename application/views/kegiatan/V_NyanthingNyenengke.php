...
<html lang="en">
  <head>
    <title>Nyanthing Kuwi Nyenengke | Festival Laweyan 2018</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
        <!-- Title -->
        <h1 class="mt-4">Nyanthing Kuwi Nyenengke</h1>
        <!-- Waktu pelaksanaan -->
        ...
        <p>
          <ol>
            <li>Masyarakat umum akan mengerti dan memahami proses menghasilkan sebuah kain batik.</li>
            <li>Masyarakat umum akan semakin menghargai hasil karya budaya kreatif asli Indonesia ini.</li>
            <li>Masyarakat umum akan semakin mencintai dan bangga untuk memakai pakaian batik yang telah diakui sebagai warisan budaya dunia asli Indonesia.</li>
          </ol>
        </p>
        <hr>
      </div>
