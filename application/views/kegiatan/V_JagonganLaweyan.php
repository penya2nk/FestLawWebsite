...
<html lang="en">
  <head>
    <title>Jagongan Laweyan | Festival Laweyan 2018</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
        <!-- Title -->
        <h1 class="mt-4">Jagongan Laweyan</h1>
        <!-- Waktu pelaksanaan -->
        ...
        <p>Kegiatan sarasehan ini rencananya akan dipandu oleh Akademisi dari UNS dalam suasana yang santai di pendopo Kelurahan dengan diiringi musik tradisional Siter dengan sajian wedangan khas Kampoeng Batik Laweyan.</p>
        <hr>
      </div>
    </div>
    <!-- /.row -->
