...
<html lang="en">
  <head>
    <title>Kawah Condrodimuko | Festival Laweyan 2018</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
        <!-- Title -->
        <h1 class="mt-4">Kawah Condrodimuko</h1>
        <!-- Waktu pelaksanaan -->
        ...
        <p>Menampilkan Sanggar Tari Melia Malang, Kelompok musik etnik Kemlaka Solo, Penyanyi Sruti Respati dan Hesti Sundari serta didukung dolanan anak Laweyan dan perform Pembatik Kampoeng Batik Laweyan.</p>
        <p>Kegiatan ini diharapkan dapat menjadi sajian hiburan yang menyenangkan bagi warga masyarakat Laweyan serta wisatawan / pengunjung Kampoeng Batik Laweyan. Bersamaan dengan acara opening ceremony ini, akan juga dilaksanakan event night sale sampai selesainya acara pembukaan. Sehingga selain wisatawan / pengunjung berbelanja, merekapun dapat sekaligus menyaksikan hiburan sambil menikmati sajian kuliner wedangan khas Kampoeng Batik Laweyan.</p>
        <hr>
      </div>
    </div>
    <!-- /.row -->
