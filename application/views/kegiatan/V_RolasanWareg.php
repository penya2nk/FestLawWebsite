...
<html lang="en">
  <head>
    <title>Rolasan Bareng Laweyan Wareg | Festival Laweyan 2018</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
        <!-- Title -->
        <h1 class="mt-4">Rolasan Bareng Laweyan Wareg</h1>
        <!-- Waktu pelaksanaan -->
        ...
        <p>Dengan mengusung konsep kuliner tempo dulu, menu Makan siang akan disiapkan dan disajikan oleh setiap RT, RW, Organisasi Masyarakat Kelurahan serta Pengusaha, di booth/tenda yang tersedia di sepanjang jalan Sidoluhur.</p>
        <hr>
      </div>
    </div>
    <!-- /.row -->
