...
<html lang="en">
  <head>
    <title>Laweyan Award | Festival Laweyan 2018</title>
...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
        <!-- Title -->
        <h1 class="mt-4">Laweyan Award</h1>
        <!-- Waktu pelaksanaan -->
        ...
        <p>Laweyan Award ini merupakan bentuk apresiasi warga Laweyan kepada perorangan, Lembaga, Instansi Pemerintah yang telah berperan aktif dalam pengembangan Kelurahan Laweyan sebagai Kampoeng wisata Batik. </p>
        <hr>
      </div>
    </div>
    <!-- /.row -->
